...
dependencies {
    ...
    implementation ("androidx.compose.runtime:runtime-livedata:1.2.0") // Update the version as needed
    implementation ("androidx.lifecycle:lifecycle-viewmodel-compose:2.4.0") // Update the version as needed
